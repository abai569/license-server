...
export function DatePicker({ value, onChange, placeholder = '例: 20281001', className, label, suffix }: DatePickerProps) {
  ...
  return (
    <label className={cn('flex-1', className)}>
      ...
      <div className="flex items-center gap-2 w-full px-3 py-2 text-sm border border-gray-300 rounded-lg bg-white focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-200 transition-colors">
        <input
          type="text"
          inputMode="numeric"
          pattern="[0-9]*"
